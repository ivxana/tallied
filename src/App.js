    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
        <div className="max-w-3xl w-full text-center">
          <h1 className="text-6xl font-bold text-gray-900 mb-4">Tallied</h1>
          <p className="text-2xl text-gray-600 mb-3">Ontario politics, explained for you.</p>
          <p className="text-lg text-gray-500 mb-10">
            See exactly how recent policy changes affect your life — based on your situation.
          </p>
          <button
            onClick={() => setCurrentStep('form')}
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-10 rounded-xl text-lg transition-colors"
          >
            Get Started →
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-5">
          <h3 className="text-xl font-bold text-gray-900 mb-5">Ready to do something about it?</h3>
